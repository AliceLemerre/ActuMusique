<article class="card card-article">
        <header class="card-header card-article-header">
            ...
            <p class="card-header-date-posted">publié le <?php $post["createdAt"]?></p>
        </header>
        <div class="card-content card-article-content">
            <div class="card-image">
                <img src="Framework/assets/images/CR.webp" alt="image placeholder article">
            </div>
        ...
        <footer class="card-footer card-footer-article">
            <a href="/post/$postId"><?php $post["comments"]?></a>
            <p>par <?php $post["user"]?></p>
            <ul class="interactions-list">
                <li><a href="" class="interaction interaction-views"><img src="Framework/assets/images/views-icon.svg" alt=""><span class="interaction-counter">0</span></a></li>
                <li><a href="" class="interaction interaction-like"><img src="Framework/assets/images/heart-icon.svg" alt=""><span class="interaction-counter">0</span></a></li>
